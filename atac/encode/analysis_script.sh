...
# everything! The main difference between this and immgen is a slight change in the usage of metadata for filtering; all else is identical
# 
...
### NOTE: You went from https://www.ncbi.nlm.nih.gov/sra?LinkName=bioproject_sra_all&from_uid=63471 and sent it all to the SRA Run Selector to
### then filter for ATAC-seq data from embryonic and postnatal samples. It was a pain and you ended up with the file "SraRunTableATAC.csv"
...
do 
	...
	then 
		...
		# For any data with only a single replicate
...
# As opposed to the Immgen data, you don't need nor want any of the coverage files, so delete them 
rm "${4}"/macs3/*.bdg "${4}"/macs3/*.xls
